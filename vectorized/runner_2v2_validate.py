...
if __name__ == '__main__':
    ...
    agent.actor_params = checkpoints.restore_checkpoint(ckpt_dir='./checkpoints/msc-v252-multi', target=agent.actor_params)
    opponent.actor_params = checkpoints.restore_checkpoint(ckpt_dir='./checkpoints/msc-v252-single10k', target=opponent.actor_params)
